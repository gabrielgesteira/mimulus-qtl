...
[**Clique aqui**](https://gabrielgesteira.github.io/mimulus-qtl/files/script-mimulus.md) para visualizar o script utilizado, ou [**aqui**](https://gabrielgesteira.github.io/mimulus-qtl/files) para visualizar os resultados obtidos com a análise.
